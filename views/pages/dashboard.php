    ...
    <div
        ...
        <div class="mt-4 flex items-end justify-between">
            <div>
                ...
                <span class="text-sm font-medium">Total Active Event</span>
            </div>
    ...
    <div
        ...
        <div class="mt-4 flex items-end justify-between">
            <div>
                <h4
                    class="text-title-md font-bold text-black dark:text-white">
                    <?=$total_inactive_event?>
                </h4>
                <span class="text-sm font-medium">Total Inactive Event</span>
            </div>
    ...
    <div
        ...
        <div class="mt-4 flex items-end justify-between">
            <div>
                ...
                <span class="text-sm font-medium">Total Admin User</span>
            </div>
